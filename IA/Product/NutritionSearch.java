...
public class NutritionSearch {
  ...
  public static ArrayList<Double> retrieveInfo(double portionSize, int selectionIndex,
ArrayList<String> nutrientsC, ArrayList<String> nutrientsP, ArrayList<String> nutrientsF){
